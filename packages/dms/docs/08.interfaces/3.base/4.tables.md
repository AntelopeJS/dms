...
and the route params of the carrying page fill the rest — which also means the
form itself reads the row id from `params.id`, not the id of the page above it.
