...
rebuilding them from the browser path. A `customPage` entry and a table view
nested in another component register no sub-page and still get their URL
serialized: both are navigated to all the same.
