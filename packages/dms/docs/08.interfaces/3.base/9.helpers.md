...
Contributing to the archive is the other side of this: a module registers a handler on the `TENANT_DATA_EXPORT` hook of the [Core](../1.core/1.introduction.md) domain, and that hook's page covers the archive sink, the manifest and what a failing contributor does to the result.
